...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'courses', name: 'courses', component: () => import('@/views/CoursesView.vue'), meta: { title: 'Курсы обучения' } },
      ...
      { path: 'gantt', name: 'gantt', component: () => import('@/views/GanttView.vue'), meta: { title: 'Диаграмма Ганта' } },
